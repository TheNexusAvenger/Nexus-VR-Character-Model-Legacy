...
local MAINCHARACTERCREATOR_CHARACTER_SCALE_CALLIBRATION = 4.2/6
...
--May want to keep false since a delay exists when changing Motor6Ds for hands and feet.
...
local HEADCREATOR_HEADSET_DOWN_OFFSET = 0.2
...
--d = (vi * t) + (0.5 * a * t^2)
--To generate height of arcs at a given point.
